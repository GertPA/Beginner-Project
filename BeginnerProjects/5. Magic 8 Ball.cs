...
int bigBrain = randomNr.Next(0,3);
int randomPos = randomNr.Next(0, 11);
int randomNeg = randomNr.Next(0,6);
...
{
    case 0:
    Console.WriteLine($"The mighty 8 balls says :: {positiveAnswer[randomPos]}"); //    print (answers[random.randint(0, len(answers)-1)] ) doing something like this ...
    break;

   case 1:
   Console.WriteLine($"The mighty 8 balls says :: {neutralAnswer[randomNeg]}");
   break;   

   default:
   Console.WriteLine($"The mighty 8 balls says :: {negativeAnswer[randomNeg]}");
   break;
